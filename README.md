...
- [API related with this frontend project](https://github.com/ishimwepati/hello-rails-back-end.git)
...
- **[Showing random greeting message]**
...
```sh
  ...
  git clone https://github.com/ishimwepati/hello-react-front-end.git
```
...
- [ ] **[Adding more components for Messages]**
